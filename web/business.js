...
const VERIFY_URL = {
   ...
   "test": "https://sdk-api.staging.equal.in/business/ie/transaction/verify"

}

const EQUAL_APP_URL = {
    "prod": "https://equal.in",
    "test": "https://staging.equal.in"
}
        ...
        response.json().then(data => {
            if (data['status'] == 'SUCCESS') {
               ...
               var identifier = data['allowed_consumers'][0]['identifier'];
                ...
                var iframeUrl = equalDomain + "/app/gateway?transaction_id=" + transactionId + "&code=" + code + "&source=maruti&sdk_launch=true&isDeviceSwitch="+isDeviceSwitch+"&embedded=true";
                if(mobile != null)
