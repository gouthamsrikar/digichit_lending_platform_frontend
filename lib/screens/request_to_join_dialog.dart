...
class RequestToJoinDialog extends StatelessWidget {
  RequestToJoinDialog(
  ...
  final ValueNotifier<bool> isConsentGiven = ValueNotifier(false);
          ...
          children: [
            Row(
              ...
              children: [
                ...
                Spacer(),
                ...[
                  if ((data.userCount ?? 0) / (data.maxCount ?? 1) > 0.75)
                    Text(
                      'Few Seats Left!',
              ...
              child: Row(
                children: [
                  ValueListenableBuilder(
                      valueListenable: isConsentGiven,
                  ...
                  const SizedBox(width: 8),
                  Text(
                    'I agree to the aforementioned details',
                    style: TextStyle(
                      color: Color(0xFF757575),
                      fontSize: 16,
                      fontFamily: 'Red Hat Text',
